...
@interface FFRecommentCarouselView ()<UICollectionViewDataSource,UICollectionViewDelegate,UIScrollViewDelegate>
...
@implementation FFRecommentCarouselView
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(FFRecommentCarouselView:didSelectImageWithInfo:)]) {
        [self.delegate FFRecommentCarouselView:self didSelectImageWithInfo:_rollingArray[indexPath.item]];
    }
