...
- (UIView *)downView {
    if (!_downView) {
        ...
        remindLabel.backgroundColor = BACKGROUND_COLOR;
...
- (void)setContactButton:(UIButton *)button {
    ...
    [button setTitleColor:NAVGATION_BAR_COLOR forState:(UIControlStateNormal)];
    button.layer.cornerRadius = 6;
    button.layer.masksToBounds = YES;
    button.layer.borderColor = NAVGATION_BAR_COLOR.CGColor;
