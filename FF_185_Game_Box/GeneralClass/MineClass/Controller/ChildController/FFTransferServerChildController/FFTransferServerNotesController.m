//
//  FFTransferServerNotesController.m
//  FF_185_Game_Box
//
...
@interface FFTransferServerNotesController () <UITableViewDelegate,UITableViewDataSource>


@end

@implementation FFTransferServerNotesController
...
- (UITableView *)tableView {
    if (!_tableView) {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, kNAVIGATION_HEIGHT, kSCREEN_WIDTH, kSCREEN_HEIGHT - kNAVIGATION_HEIGHT) style:(UITableViewStylePlain)];
