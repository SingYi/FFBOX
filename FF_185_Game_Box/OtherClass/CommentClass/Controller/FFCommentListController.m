...
@interface FFCommentListController () <FFDriveCommentCellDelegate>
...
- (void)showCellSelectionWithIndexPath:(NSIndexPath *)indexPath {
    ...
    [UIAlertController showAlertControllerWithViewController:[FFControllerManager sharedManager].rootViewController alertControllerStyle:(UIAlertControllerStyleActionSheet) title:@"评论操作" message:nil cancelButtonTitle:@"取消" destructiveButtonTitle:destructiveTitle otherButtonTitles:array CallBackBlock:^(NSInteger btnIndex) {
