...
+ (void)hotGameWithCompletion:(void (^)(NSDictionary *, BOOL))completion {
    ...
    [FFBasicModel postRequestWithURL:[FFMapModel map].GAME_GETHOT params:dict completion:^(NSDictionary *content, BOOL success) {
        REQUEST_COMPLETION;
    }];
}
...
+ (void)searchGameWithKeyword:(NSString *)keyword Completion:(void (^)(NSDictionary * _Nullable, BOOL))completion {
    ...
    [FFBasicModel postRequestWithURL:[FFMapModel map].GAME_SEARCH_LIST params:dict completion:^(NSDictionary *content, BOOL success) {
        REQUEST_COMPLETION;
    }];
}
...
+ (void)UnreadMessagesWithUid:(NSString *)uid Completion:(void (^)(NSDictionary *, BOOL))completion {
    ...
    [FFBasicModel postRequestWithURL:[FFMapModel map].MESSAGE_UNREAD params:dict completion:^(NSDictionary *content, BOOL success) {
